          ...
          <div className="row mb-5">
            <div className="col-lg-7 fs-4">
              ...
              <p style={{ lineHeight: "1.3" }} className="fs-3">
                We&rsquo;re here to assist you every step of the way. Whether
                you have questions about our products, need technical support,
                or simply want to say hello, don’t hesitate to reach out. Our
                dedicated team at Clio is ready to provide personalized
            ...
            <div className="col-lg-4">
              <div className="gap-3 h-100 bg-main-2 p-3 text-main d-flex align-items-center">
                <FontAwesomeIcon
                  ...
                  icon={faEnvelope}
                />
                <p className="m-0 fs-3" style={{ wordBreak: "break-all" }}>
                  {" "}
                  info@cliogems.com{" "}
                </p>
              </div>
            ...
            <div className="col-lg-4">
              <div className="gap-3 h-100 bg-main-2 p-3 text-main d-flex align-items-center">
                ...
                <p className="m-0 fs-3">
                  {" "}
                  123 Diamound Strret, Luxe City, Jewelania{" "}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-8 offset-lg-1">
              <div>
                ...
                <p className="fs-4">
                  ...
                  form up there. Your satisfaction is our priority, and we look
                  forward to connecting with you to ensure your needs are met
                  seamlessly.
                </p>
              </div>
            </div>
